...
<html>
  ...
  <body>
    ...
    <div id="loading-screen" class="z-q9">
      <div class="container g-5 g-sm-3">
        <div class="row">
          <div class="col-12 d-flex justify-content-center">
            <div id="Title-1" class="position-absolute m-t-70 d-flex flex-column text-start align-content-start" style="top: 26%">
    ...
    <section id="信頼できる仲間とつながろう " class="container g-0 m-t-sm-100 m-t-md-100 m-t-lg-0">
      <div class="row align-items-end g-0 position-relative">
        <div class="col-md-5 order-md-last text-lg-end text-center my-md-auto my-0">
