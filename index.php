      ...
      <div class="container g-5 g-sm-3">
        <div class="row">
          ...
          <p class="text-center m-t-70 fs-16 letter-space-160 fw-1000 lh-18 f-jp">
            ドマログは、体験を価値に変えて、殻を<br class="show-on-phone" />
            破り潜在能力を引き出すのに最適です。<br /><br
              class="show-on-phone"
            />
            簡単にメモをとり見直せるだけでなく、<br />
            仲間の視点とのギャップから思考の軸を<br class="show-on-phone" />
            整理することもできます。<br /><br class="show-on-phone" />
            君と一緒にセンスの壁を超えるため、<br class="show-on-phone" />
            これからも進化し続けます。
          </p>
        </div>
      </div>
    ...
    <section class="p-t-70 p-b-180">
      <div class="container g-5 g-sm-3">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-12 p-0 d-flex flex-column">
        ...
        <div class="col-md-7">
          ...
          >
            ...
            <h2 class="fs-16 letter-space-160 m-t-30 lh-18 fw-1000 f-jp">
              「メモをとる」というちょっとしたことからはじめよう。たかがメモと思うかもしれ
              ない。しかし、メモをとることで上達することを知っている人たちはその小さくて大
              きな行動をしている。君に必要なのはたった10秒。さあ、体験を価値に変えよう。
            </h2>
        ...
        <div class="col-md-7">
          ...
          >
            ...
            <h2 class="fs-16 letter-space-160 m-t-33 lh-18 fw-1000 f-jp">
              どのようにメモを取ればよいのか、その内容は相応しいのか。これを解決するために
              「仲間と共有する」という手がある。自分だけで考えるのではなく、多くのプレイ
              ヤーの経験を反映する。それは世界中のプレイヤーが自分のコーチになるとも言え
              る。
            </h2>
      ...
      <div class="row align-items-end g-0 position-relative">
        ...
        <div class="col-md-7">
          ...
          >
            ...
            <h2 class="fs-16 letter-space-160 m-t-30 lh-18 fw-1000 f-jp">
              「簡単に仲間の取り組み方がみえる。今の君に必要なことを的確にアドバイスできるエ
              キスパートがいる。悩みをシェアしてみよう。一方で君の経験を必要としている仲間
              がいる。知恵を伝えよう。近いレベルでプレーできる仲間が増えた方がもっとワ
              クワクできる。
            </h2>
            <div class="d-flex align-items-center m-t-30">
              <h3 class="cl-secondary fs-16 letter-space-160 fw-1000 f-jp">機能：</h3>
        ...
        <div class="row">
          <div class="text-center m-t-75">
            ...
            <h2 class="fs-24 fs-sm-18 m-t-60 letter-space-240 letter-space-sm-180 fw-1000 m-t-sm-30 lh-18 f-jp">
              お問い合わせは<br class="show-on-phone" />
              Discordチャンネルから。
            </h2>
